...
console.log(`${cargoHold.pop()} has been removed from the cargoHold array.`);
console.log(`Contents of the array\n${cargoHold}`);
console.log();

//3) Remove the first item from the array with shift. Print the element removed and the updated array.
console.log(`${cargoHold.shift()} has been removed from the cargoHold array.`);
console.log(`Contents of the array\n${cargoHold}`);
console.log();
...
console.log(`The array [${cargoHold}] contains ${cargoHold.length} items`);